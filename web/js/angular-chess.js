(function () {
  ...
  .service('NywtonChessGameService', ['$log', '$window', '$rootScope', function ChessGameService($log, $window,
                                                                                                 $rootScope) {
    ...
    this.onSnapEnd = function(game, board, source, target, piece) {
        if($window.chessMaps == null){
            $window.chessMaps = [];
        }
        //console.log($window.chessMaps);
      $window.chessMaps.push({
          start: source,
          end: target,
          figure: piece
      });
        $rootScope.$broadcast("done.chess");
